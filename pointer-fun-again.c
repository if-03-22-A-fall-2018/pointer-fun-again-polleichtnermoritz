 ...
 * ----------------------------------------------------------
 * Description:
 * a more complex version of ponter fun
 * ----------------------------------------------------------
 */
#include <stdio.h>
...
int main(int argc, char const *argv[]) {
  ...
  struct PlayStruct play_struct={5,4.8,"moritz"};
  ...
  printf("\n");
  print_struct(play_struct,play_struct_pointer);
  //the value of ps does not change, because pps points at the adress of ps, so the change of pps affects both

  char another_string[16]="moritzmoritz";
